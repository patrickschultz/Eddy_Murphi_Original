...
/* IM<b> */
void CheckMemAvailable (unsigned long bytes);
/* IM<e> */
...
{
  enum
  { undef_value = UNDEFVAL };	// Uli: nice way to declare constants
...
public:
  ...
  void set_self_ar (char *n1, char *n2, int os)
  {				// sets the name
  ...
  void set_self_2 (char *n1, char *n2, int os)
  {				// sets the name
