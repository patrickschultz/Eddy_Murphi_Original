...
#include <stdarg.h>
#include <stream.h>
// #include <limits.h> /* for BITSPERBYTE and BITS() */
...
/* IM: BITS not always present in values.h, sometimes it is never defined in the
system */
#ifndef BITS
...
extern const unsigned short numrules;
...
extern int TotalNetworkMessagesExchanged;

// for Heuristic 1
extern state_set *rw_ht;

// for Heuristic 2
extern state **rw_fronts;
extern int size_rw_fronts;
extern int num_random_walks;
extern bool start_initial_rw;
extern StateManager *BoundedStateSet;

// for Heuristic 3
extern int num_final_random_walks;
extern int final_rw_interval;
extern int total_final_rw_steps;
extern bool start_final_rw;
extern double user_input_time;

// for Heuristic 4
extern state **frontier_array;
extern unsigned long max_elts_frontier_array;
extern unsigned long num_elts_frontier_array;
