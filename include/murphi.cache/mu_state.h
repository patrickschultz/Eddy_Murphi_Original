...
public:
  ...
  inline unsigned long MaxElts( void ) { return max_active_states; } //sarebbe meglio dire TANTI...
  unsigned long NumElts( void ) { return num_elts_head + num_elts_tail + global_rear + global_front; }
  inline bool isempty( void ) { return num_elts_head + num_elts_tail + global_rear + global_front == 0; }
...
public:
  ...
  inline unsigned long NumOverwrites() { return ht_overwrite; };
...
/********************
  $Log: mu_state.h,v $
  Revision 1.2  2001/02/28 20:32:12  enrico
  modified simple_was_present

  Revision 1.1  2001/02/02 08:44:28  enrico
  Initial revision
...
/*
$Log: mu_state.h,v $
Revision 1.3  2001/06/11 16:39:11  giuseppe 
