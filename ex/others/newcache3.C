...
class mu_1_Proc: public mu__byte
{
 public:
  ...
  mu_1_Proc (char *name, int os): mu__byte(2, 5, 3, name, os) {};
  mu_1_Proc (void): mu__byte(2, 5, 3) {};
  mu_1_Proc (int val): mu__byte(2, 5, 3, "Parameter or function result.", 0)
    { operator=(val); };
...
char *mu_1_Node::values[] = {"Home_1","Proc_1","Proc_2","Proc_3","Proc_4",NULL };
...
class mu_1_Message_Type: public mu__byte
{
 public:
  ...
  {
    if (val.defined())
      return ( s << mu_1_Message_Type::values[ int(val) - 9] );
    else return ( s << "Undefined" );
  };

  mu_1_Message_Type (char *name, int os): mu__byte(9, 23, 4, name, os) {};
  mu_1_Message_Type (void): mu__byte(9, 23, 4) {};
  mu_1_Message_Type (int val): mu__byte(9, 23, 4, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
class mu_1__type_1: public mu__byte
{
 public:
  ...
  {
    if (val.defined())
      return ( s << mu_1__type_1::values[ int(val) - 24] );
    else return ( s << "Undefined" );
  };

  mu_1__type_1 (char *name, int os): mu__byte(24, 29, 3, name, os) {};
  mu_1__type_1 (void): mu__byte(24, 29, 3) {};
  mu_1__type_1 (int val): mu__byte(24, 29, 3, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
class mu__subrange_12: public mu__byte
{
 public:
  ...
  mu__subrange_12 (char *name, int os): mu__byte(0, 3, 3, name, os) {};
...
class mu_1__type_4: public mu__byte
{
 public:
  ...
  mu_1__type_4 (char *name, int os): mu__byte(0, 3, 3, name, os) {};
...
void mu_1__type_5::set_self(char *n, int os)
{
  ...
  mu_Inv_Count.set_self_2(name, ".Inv_Count", os + 18 );
}
...
void mu_1__type_6::set_self( char *n, int os)
  {
    int i=0;
    name = n;
array[i].set_self_ar(n,"Address_1", i * 21 + os);i++;
}
...
class mu_1__type_7: public mu__byte
{
 public:
  ...
  {
    if (val.defined())
      return ( s << mu_1__type_7::values[ int(val) - 30] );
    else return ( s << "Undefined" );
  };

  mu_1__type_7 (char *name, int os): mu__byte(30, 32, 2, name, os) {};
  mu_1__type_7 (void): mu__byte(30, 32, 2) {};
  mu_1__type_7 (int val): mu__byte(30, 32, 2, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
class mu_1__type_11: public mu__byte
{
 public:
  ...
  {
    if (val.defined())
      return ( s << mu_1__type_11::values[ int(val) - 33] );
    else return ( s << "Undefined" );
  };

  mu_1__type_11 (char *name, int os): mu__byte(33, 38, 3, name, os) {};
  mu_1__type_11 (void): mu__byte(33, 38, 3) {};
  mu_1__type_11 (int val): mu__byte(33, 38, 3, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
void mu_1__type_15::set_self( char *n, int os)
  {
    int i=0;
    name = n;
array[i].set_self_ar(n,"Home_1", i * 120 + os);i++;
array[i].set_self_ar(n,"Proc_1", i * 120 + os);i++;
array[i].set_self_ar(n,"Proc_2", i * 120 + os);i++;
array[i].set_self_ar(n,"Proc_3", i * 120 + os);i++;
array[i].set_self_ar(n,"Proc_4", i * 120 + os);i++;
}
...
void mu_1__type_16::set_self( char *n, int os)
  {
    int i=0;
    name = n;
array[i].set_self_ar(n,"Home_1", i * 23 + os);i++;
}
    ...
    if ( ( index >= 2 ) && ( index <= 5 ) )
    ...
    else
      {
        if (index==UNDEFVAL) 
          ...
          Error.Error("Funny index value %d for %s: Proc is internally represented from 5 to 2.\nInternal Error in Type checking.",index, name);
        return array[0];
      }
#else
    return array[ index - 2 ];
...
class mu__subrange_31: public mu__byte
{
 public:
  ...
  mu__subrange_31 (char *name, int os): mu__byte(0, 3, 3, name, os) {};
...
class mu__subrange_34: public mu__byte
{
 public:
  ...
  mu__subrange_34 (char *name, int os): mu__byte(0, 3, 3, name, os) {};
...
class mu__subrange_35: public mu__byte
{
 public:
  ...
  mu__subrange_35 (char *name, int os): mu__byte(0, 3, 3, name, os) {};
...
class mu__subrange_36: public mu__byte
{
 public:
  ...
  mu__subrange_36 (char *name, int os): mu__byte(0, 3, 3, name, os) {};
...
class mu__subrange_37: public mu__byte
{
 public:
  ...
  mu__subrange_37 (char *name, int os): mu__byte(0, 3, 3, name, os) {};
...
const int mu_Cache_Read = 9;
const int mu_Cache_Read_Ex = 10;
const int mu_Cache_Promote = 11;
const int mu_Uncache = 12;
const int mu_Write_Back = 13;
const int mu_Update = 14;
const int mu_Data = 15;
const int mu_Invalidate = 16;
const int mu_Uncache_Ack = 17;
const int mu_Write_Back_Ack = 18;
const int mu_Inv_Ack = 19;
const int mu_Fw_Cache_R = 20;
const int mu_Fw_Cache_R_Ex = 21;
const int mu_Ack_Fw_Cache_Ex = 22;
const int mu_Cache_Promote_Ack = 23;
const int mu_Inv = 24;
const int mu_Shared_Remote = 25;
const int mu_Master_Remote = 26;
const int mu_Wait_Inv = 27;
const int mu_Wait_Update = 28;
const int mu_Wait_WB = 29;
const int mu_I = 30;
const int mu_S = 31;
const int mu_M = 32;
const int mu_NOP = 33;
const int mu_CR_Pend = 34;
const int mu_CRE_Pend = 35;
const int mu_CP_Pend = 36;
const int mu_WB_Pend = 37;
const int mu_Uncache_Pend = 38;
/*** Variable declaration ***/
mu_1__type_15 mu_Net("Net",0);

/*** Variable declaration ***/
mu_1__type_16 mu_Homes("Homes",600);

/*** Variable declaration ***/
mu_1__type_17 mu_Procs("Procs",623);
...
public:
  ...
  void NextRule(unsigned & what_rule)
  {
    ...
    mu_M_Index.value((r % 8) + 0);
    r = r / 8;
    while (what_rule < 40 && mu_M_Index.value()<8 )
      {
        if ( ( TRUE  ) ) {
              if (mu_true) {
                if ( ( TRUE && mu_Net[mu_n].in(mu_M_Index) ) )
...
bool Condition(unsigned r)
{
  ...
  if (r>=8 && r<=39) return R1.Condition(r-8);
  if (r>=40 && r<=47) return R2.Condition(r-40);
  if (r>=48 && r<=51) return R3.Condition(r-48);
  if (r>=52 && r<=55) return R4.Condition(r-52);
  if (r>=56 && r<=59) return R5.Condition(r-56);
  if (r>=60 && r<=63) return R6.Condition(r-60);
  if (r>=64 && r<=67) return R7.Condition(r-64);
Error.Notrace("Internal: NextStateGenerator -- checking condition for nonexisting rule.");
}
void Code(unsigned r)
{
  if (r<=7) { R0.Code(r-0); return; } 
  if (r>=8 && r<=39) { R1.Code(r-8); return; } 
  if (r>=40 && r<=47) { R2.Code(r-40); return; } 
  if (r>=48 && r<=51) { R3.Code(r-48); return; } 
  if (r>=52 && r<=55) { R4.Code(r-52); return; } 
  if (r>=56 && r<=59) { R5.Code(r-56); return; } 
  if (r>=60 && r<=63) { R6.Code(r-60); return; } 
  if (r>=64 && r<=67) { R7.Code(r-64); return; } 
}
int Priority(unsigned short r)
{
  if (r<=7) { return R0.Priority(); } 
  if (r>=8 && r<=39) { return R1.Priority(); } 
  if (r>=40 && r<=47) { return R2.Priority(); } 
  if (r>=48 && r<=51) { return R3.Priority(); } 
  if (r>=52 && r<=55) { return R4.Priority(); } 
  if (r>=56 && r<=59) { return R5.Priority(); } 
  if (r>=60 && r<=63) { return R6.Priority(); } 
  if (r>=64 && r<=67) { return R7.Priority(); } 
}
char * Name(unsigned r)
{
  if (r<=7) return R0.Name(r-0);
  if (r>=8 && r<=39) return R1.Name(r-8);
  if (r>=40 && r<=47) return R2.Name(r-40);
  if (r>=48 && r<=51) return R3.Name(r-48);
  if (r>=52 && r<=55) return R4.Name(r-52);
  if (r>=56 && r<=59) return R5.Name(r-56);
  if (r>=60 && r<=63) return R6.Name(r-60);
  if (r>=64 && r<=67) return R7.Name(r-64);
  return NULL;
}
};
...
mu__quant38 = TRUE;
{
for(int mu_addr = 6; mu_addr <= 6; mu_addr++) {
bool mu__boolexpr39;
bool mu__boolexpr40;
bool mu__boolexpr41;
bool mu__boolexpr42;
                ...
                for (j=0; j<count_mu_1_Value; j++) //scan through element priority
                  {
                    ...
                    for (k=0; k<current_size; k++) // scan array index
                      ...
                      if (pos_multisetindex[i][k] 
                          ...
                          && pos_mu_1_Value[j][(*this)[k].mu_Value-7])
                        {
                          exists = TRUE;
                          goodset_multisetindex[k] = TRUE;
                          goodset_mu_1_Value[(*this)[k].mu_Value-7] = TRUE;
                        }
                    if (exists)
                      {
                        // set split for the array index type
