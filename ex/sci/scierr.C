/******************************
  Program "scierr.m" compiled by "Eddy_Murphi Release 3.2.4"
...
class mu_1_ProcId: public mu__byte
{
 public:
  ...
  mu_1_ProcId (char *name, int os): mu__byte(1, 2, 2, name, os) {};
...
class mu_1_MemoryId: public mu__byte
{
 public:
  ...
  mu_1_MemoryId (char *name, int os): mu__byte(3, 3, 1, name, os) {};
...
class mu_1_NodeId: public mu__byte
{
 public:
  ...
  mu_1_NodeId (char *name, int os): mu__byte(0, 2, 2, name, os) {};
...
char *mu_1_NodeId::values[] = {"ProcId_1","ProcId_2","MemoryId_1",NULL };
...
class mu_1_MemoryLineId: public mu__byte
{
 public:
  ...
  mu_1_MemoryLineId (char *name, int os): mu__byte(4, 4, 1, name, os) {};
...
class mu_1_CacheLineId: public mu__byte
{
 public:
  ...
  mu_1_CacheLineId (char *name, int os): mu__byte(5, 5, 1, name, os) {};
...
class mu_1_Data: public mu__byte
{
 public:
  ...
  mu_1_Data (char *name, int os): mu__byte(6, 6, 1, name, os) {};
...
class mu_1_AccessCommandsReq: public mu__byte
{
 public:
  ...
  mu_1_AccessCommandsReq (char *name, int os): mu__byte(7, 9, 2, name, os) {};
...
class mu_1_AccessCommandsRes: public mu__byte
{
 public:
  ...
  mu_1_AccessCommandsRes (char *name, int os): mu__byte(10, 11, 2, name, os) {};
...
class mu_1_MemoryCacheCommands: public mu__byte
{
 public:
  ...
  mu_1_MemoryCacheCommands (char *name, int os): mu__byte(12, 70, 6, name, os) {};
...
class mu_1_MemoryCacheStates: public mu__byte
{
 public:
  ...
  mu_1_MemoryCacheStates (char *name, int os): mu__byte(79, 228, 8, name, os) {};
...
void mu_1_ReqPacket::set_self(char *n, int os)
{
  ...
  mu_cmd.set_self_2(name, ".cmd", os + 2 );
  mu_sourceId.set_self_2(name, ".sourceId", os + 4 );
  mu_offset.set_self_2(name, ".offset", os + 6 );
  mu_mopCop.set_self_2(name, ".mopCop", os + 7 );
  mu_s.set_self_2(name, ".s", os + 13 );
  mu_eh.set_self_2(name, ".eh", os + 15 );
  mu_data.set_self_2(name, ".data", os + 17 );
  mu_newId.set_self_2(name, ".newId", os + 18 );
  mu_memId.set_self_2(name, ".memId", os + 20 );
}
...
void mu_1_ResPacket::set_self(char *n, int os)
{
  ...
  mu_backId.set_self_2(name, ".backId", os + 17 );
}
...
void mu_1_MemoryLine::set_self(char *n, int os)
{
  ...
  mu_data.set_self_2(name, ".data", os + 10 );
}
...
void mu_1__type_0::set_self( char *n, int os)
  {
    int i=0;
    name = n;
array[i].set_self_ar(n,"MemoryLineId_1", i * 11 + os);i++;
}
...
void mu_1_CacheLine::set_self(char *n, int os)
{
  ...
  mu_cState.set_self_2(name, ".cState", os + 0 );
  mu_forwId.set_self_2(name, ".forwId", os + 8 );
  mu_backId.set_self_2(name, ".backId", os + 10 );
  mu_memId.set_self_2(name, ".memId", os + 12 );
  mu_addrOffset.set_self_2(name, ".addrOffset", os + 14 );
  mu_data.set_self_2(name, ".data", os + 15 );
}
...
void mu_1__type_1::set_self( char *n, int os)
  {
    int i=0;
    name = n;
array[i].set_self_ar(n,"CacheLineId_1", i * 16 + os);i++;
}
...
class mu_1_InstructionType: public mu__long
{
 public:
  ...
  mu_1_InstructionType (char *name, int os): mu__long(295, 300, 3, name, os) {};
  ...
  char * Name() { return values[ value() -295]; };
  virtual void Permute(PermSet& Perm, int i);
  virtual void SimpleCanonicalize(PermSet& Perm);
  virtual void Canonicalize(PermSet& Perm);
  virtual void SimpleLimit(PermSet& Perm);
...
class mu_1_InstructionPhase: public mu__long
{
 public:
  ...
  mu_1_InstructionPhase (char *name, int os): mu__long(301, 304, 3, name, os) {};
  ...
  char * Name() { return values[ value() -301]; };
  virtual void Permute(PermSet& Perm, int i);
  virtual void SimpleCanonicalize(PermSet& Perm);
  virtual void Canonicalize(PermSet& Perm);
  virtual void SimpleLimit(PermSet& Perm);
...
void mu_1_ExecUnit::set_self(char *n, int os)
{
  ...
  mu_resPacket.set_self_2(name, ".resPacket", os + 97 );
}
...
void mu_1_Proc::set_self(char *n, int os)
{
  ...
  mu_cache.set_self_2(name, ".cache", os + 116 );
}
...
void mu_1__type_2::set_self( char *n, int os)
  {
    int i=0;
    name = n;
array[i].set_self_ar(n,"ProcId_1", i * 132 + os);i++;
array[i].set_self_ar(n,"ProcId_2", i * 132 + os);i++;
}
...
void mu_1__type_3::set_self( char *n, int os)
  {
    int i=0;
    name = n;
array[i].set_self_ar(n,"MemoryId_1", i * 11 + os);i++;
}
