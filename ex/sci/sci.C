/******************************
  Program "sci.m" compiled by "Eddy_Murphi Release 3.2.4"
...
class mu_1_ProcId: public mu__byte
{
 public:
  ...
  mu_1_ProcId (char *name, int os): mu__byte(1, 3, 2, name, os) {};
...
class mu_1_MemoryId: public mu__byte
{
 public:
  ...
  mu_1_MemoryId (char *name, int os): mu__byte(4, 4, 1, name, os) {};
...
class mu_1_NodeId: public mu__byte
{
 public:
  ...
  mu_1_NodeId (char *name, int os): mu__byte(0, 3, 3, name, os) {};
...
char *mu_1_NodeId::values[] = {"ProcId_1","ProcId_2","ProcId_3","MemoryId_1",NULL };
...
class mu_1_MemoryLineId: public mu__byte
{
 public:
  ...
  mu_1_MemoryLineId (char *name, int os): mu__byte(5, 5, 1, name, os) {};
...
class mu_1_CacheLineId: public mu__byte
{
 public:
  ...
  mu_1_CacheLineId (char *name, int os): mu__byte(6, 6, 1, name, os) {};
...
class mu_1_Data: public mu__byte
{
 public:
  ...
  mu_1_Data (char *name, int os): mu__byte(7, 7, 1, name, os) {};
...
class mu_1_AccessCommandsReq: public mu__byte
{
 public:
  ...
  mu_1_AccessCommandsReq (char *name, int os): mu__byte(8, 10, 2, name, os) {};
...
char *mu_1_AccessCommandsReq::values[] = {"SC_MREAD","SC_MWRITE64","SC_CREAD",NULL };
...
class mu_1_AccessCommandsRes: public mu__byte
{
 public:
  ...
  mu_1_AccessCommandsRes (char *name, int os): mu__byte(11, 12, 2, name, os) {};
...
char *mu_1_AccessCommandsRes::values[] = {"SC_RESP00","SC_RESP64",NULL };
...
class mu_1_MemoryCacheCommands: public mu__byte
{
 public:
  ...
  mu_1_MemoryCacheCommands (char *name, int os): mu__byte(13, 71, 6, name, os) {};
...
char *mu_1_SStatValues::values[] = {"RESP_NORMAL","RESP_ADVICE","RESP_GONE","RESP_LOCKED","RESP_CONFLICT","RESP_DATA","RESP_TYPE","RESP_ADDRESS",NULL };
...
class mu_1_MemoryCacheStates: public mu__byte
{
 public:
  ...
  mu_1_MemoryCacheStates (char *name, int os): mu__byte(80, 229, 8, name, os) {};
  ...
  char * Name() { return values[ value() -80]; };
  virtual void Permute(PermSet& Perm, int i);
  virtual void SimpleCanonicalize(PermSet& Perm);
  virtual void Canonicalize(PermSet& Perm);
  virtual void SimpleLimit(PermSet& Perm);
...
char *mu_1_DataFlags::values[] = {"NORM_NONE","NORM_DATA","NORM_NULL","NORM_SKIP","FULL_NONE","FULL_DATA","FULL_NULL","HUGE_TAGS","LOCK_DATA","MISS_MORE","MISS_NONE",NULL };
...
char *mu_1_AccessTypes::values[] = {"CT_ONLY_DIRTY","CT_HEAD_DIRTY","CT_MID_VALID","CT_HEAD_IDLE","CT_ONLY_FRESH","CT_HEAD_FRESH","CT_ONLYP_DIRTY","CT_HEAD_RETN","CT_HEAD_CLEAN","CT_HEAD_WASH","CT_TAIL_EXCL","CT_HEAD_EXCL","CT_ONLY_USED","CT_HEAD_NEED","CT_TAIL_USED","CT_HEAD_USED",NULL };
...
char *mu_1_FetchOptions::values[] = {"CO_FETCH","CO_LOAD","CO_STORE",NULL };
...
char *mu_1_FindFlags::values[] = {"FF_FIND","FF_WAIT","FF_LOAD","FF_STORE","FF_LOCK","FF_ENQOLB","FF_INDEX",NULL };
...
char *mu_1_BypassOptions::values[] = {"CU_BYPASS","CU_LOCAL","CU_GLOBAL",NULL };
...
char *mu_1_StableGroups::values[] = {"SG_NONE","SG_INVALID","SG_STALE","SG_GLOBAL","SG_LOCAL",NULL };
...
class mu_1_AttachStatus
{
 public:
  ...
  mu_1_AttachStatus ( char *n, int os ) { set_self(n,os); };
...
virtual bool ismember() { Error.Error("Checking membership for a non-base type"); return TRUE;}
  ...
  void mu_1_AttachStatus::set_self_ar( char *n1, char *n2, int os ) {
  ...
  void mu_1_AttachStatus::set_self_2( char *n1, char *n2, int os ) {
    strcpy( longname, n1 );
    strcat( longname, n2 );
    set_self( longname, os );
  };
void mu_1_AttachStatus::set_self(char *n, int os)
{
  name = n;
  mu_cState.set_self_2(name, ".cState", os + 0 );
  mu_backId.set_self_2(name, ".backId", os + 8 );
}
...
class mu_1_ReqPacket
{
 public:
  ...
  mu_1_ReqPacket ( char *n, int os ) { set_self(n,os); };
  mu_1_ReqPacket ( void ) {};
...
virtual bool ismember() { Error.Error("Checking membership for a non-base type"); return TRUE;}
  ...
  void mu_1_ReqPacket::set_self_ar( char *n1, char *n2, int os ) {
    int l1 = strlen(n1), l2 = strlen(n2);
    strcpy( longname, n1 );
    longname[l1] = '[';
    strcpy( longname+l1+1, n2 );
  ...
  void mu_1_ReqPacket::set_self_2( char *n1, char *n2, int os ) {
    strcpy( longname, n1 );
    strcat( longname, n2 );
    set_self( longname, os );
  };
void mu_1_ReqPacket::set_self(char *n, int os)
{
  name = n;
  mu_targetId.set_self_2(name, ".targetId", os + 0 );
  mu_cmd.set_self_2(name, ".cmd", os + 3 );
  mu_sourceId.set_self_2(name, ".sourceId", os + 5 );
  mu_offset.set_self_2(name, ".offset", os + 8 );
  mu_mopCop.set_self_2(name, ".mopCop", os + 9 );
  mu_s.set_self_2(name, ".s", os + 15 );
  mu_eh.set_self_2(name, ".eh", os + 17 );
  mu_data.set_self_2(name, ".data", os + 19 );
  mu_newId.set_self_2(name, ".newId", os + 20 );
  mu_memId.set_self_2(name, ".memId", os + 23 );
}
...
class mu_1_ResPacket
{
 public:
  ...
  mu_1_NodeId mu_backId;
  mu_1_ResPacket ( char *n, int os ) { set_self(n,os); };
  mu_1_ResPacket ( void ) {};
...
virtual bool ismember() { Error.Error("Checking membership for a non-base type"); return TRUE;}
  ...
  void mu_1_ResPacket::set_self_ar( char *n1, char *n2, int os ) {
    int l1 = strlen(n1), l2 = strlen(n2);
    strcpy( longname, n1 );
    longname[l1] = '[';
    strcpy( longname+l1+1, n2 );
  ...
  void mu_1_ResPacket::set_self_2( char *n1, char *n2, int os ) {
    strcpy( longname, n1 );
    strcat( longname, n2 );
    set_self( longname, os );
  };
void mu_1_ResPacket::set_self(char *n, int os)
{
  name = n;
  mu_cmd.set_self_2(name, ".cmd", os + 0 );
  mu_cn.set_self_2(name, ".cn", os + 2 );
  mu_co.set_self_2(name, ".co", os + 4 );
  mu_mCState.set_self_2(name, ".mCState", os + 6 );
  mu_data.set_self_2(name, ".data", os + 14 );
  mu_forwId.set_self_2(name, ".forwId", os + 15 );
  mu_backId.set_self_2(name, ".backId", os + 18 );
}
...
class mu_1_MemoryLine
{
 public:
  ...
  mu_1_NodeId mu_forwId;
  mu_1_Data mu_data;
  mu_1_MemoryLine ( char *n, int os ) { set_self(n,os); };
...
virtual bool ismember() { Error.Error("Checking membership for a non-base type"); return TRUE;}
  ...
  void mu_1_MemoryLine::set_self_ar( char *n1, char *n2, int os ) {
    int l1 = strlen(n1), l2 = strlen(n2);
    strcpy( longname, n1 );
    longname[l1] = '[';
    strcpy( longname+l1+1, n2 );
  ...
  void mu_1_MemoryLine::set_self_2( char *n1, char *n2, int os ) {
    strcpy( longname, n1 );
    strcat( longname, n2 );
    set_self( longname, os );
  };
void mu_1_MemoryLine::set_self(char *n, int os)
{
  name = n;
  mu_mState.set_self_2(name, ".mState", os + 0 );
  mu_forwId.set_self_2(name, ".forwId", os + 8 );
  mu_data.set_self_2(name, ".data", os + 11 );
}
...
void mu_1__type_0::set_self( char *n, int os)
  {
    int i=0;
    name = n;
array[i].set_self_ar(n,"MemoryLineId_1", i * 12 + os);i++;
}
...
class mu_1_Memory
{
 public:
  ...
  mu_1_Memory ( char *n, int os ) { set_self(n,os); };
  mu_1_Memory ( void ) {};
...
virtual bool ismember() { Error.Error("Checking membership for a non-base type"); return TRUE;}
  ...
  void mu_1_Memory::set_self_ar( char *n1, char *n2, int os ) {
    int l1 = strlen(n1), l2 = strlen(n2);
    strcpy( longname, n1 );
    longname[l1] = '[';
    strcpy( longname+l1+1, n2 );
  ...
  void mu_1_Memory::set_self_2( char *n1, char *n2, int os ) {
    strcpy( longname, n1 );
    strcat( longname, n2 );
    set_self( longname, os );
  };
void mu_1_Memory::set_self(char *n, int os)
{
  name = n;
...
void mu_1_CacheLine::set_self(char *n, int os)
{
  ...
  mu_cState.set_self_2(name, ".cState", os + 0 );
  mu_forwId.set_self_2(name, ".forwId", os + 8 );
  mu_backId.set_self_2(name, ".backId", os + 11 );
  mu_memId.set_self_2(name, ".memId", os + 14 );
  mu_addrOffset.set_self_2(name, ".addrOffset", os + 17 );
  mu_data.set_self_2(name, ".data", os + 18 );
}
...
void mu_1__type_1::set_self( char *n, int os)
  {
    int i=0;
    name = n;
array[i].set_self_ar(n,"CacheLineId_1", i * 19 + os);i++;
}
...
class mu_1_InstructionType: public mu__long
{
 public:
  ...
  mu_1_InstructionType (char *name, int os): mu__long(296, 301, 3, name, os) {};
  ...
  char * Name() { return values[ value() -296]; };
  virtual void Permute(PermSet& Perm, int i);
  virtual void SimpleCanonicalize(PermSet& Perm);
  virtual void Canonicalize(PermSet& Perm);
  virtual void SimpleLimit(PermSet& Perm);
...
char *mu_1_InstructionType::values[] = {"I_NONE","I_LOAD","I_STORE","I_FLUSH","I_DELETE","I_LOCK",NULL };
...
class mu_1_InstructionPhase: public mu__long
{
 public:
  ...
  mu_1_InstructionPhase (char *name, int os): mu__long(302, 305, 3, name, os) {};
  ...
  char * Name() { return values[ value() -302]; };
  virtual void Permute(PermSet& Perm, int i);
  virtual void SimpleCanonicalize(PermSet& Perm);
  virtual void Canonicalize(PermSet& Perm);
  virtual void SimpleLimit(PermSet& Perm);
...
char *mu_1_InstructionPhase::values[] = {"I_START","I_ALLOCATE","I_SETUP","I_CLEANUP",NULL };
...
class mu_1_LB
{
 public:
  ...
  mu_1_MemoryLineId mu_addrOffset;
  mu_1_LB ( char *n, int os ) { set_self(n,os); };
  mu_1_LB ( void ) {};
...
virtual bool ismember() { Error.Error("Checking membership for a non-base type"); return TRUE;}
  ...
  void mu_1_LB::set_self_ar( char *n1, char *n2, int os ) {
    int l1 = strlen(n1), l2 = strlen(n2);
    strcpy( longname, n1 );
    longname[l1] = '[';
    strcpy( longname+l1+1, n2 );
  ...
  void mu_1_LB::set_self_2( char *n1, char *n2, int os ) {
    strcpy( longname, n1 );
    strcat( longname, n2 );
    set_self( longname, os );
  };
void mu_1_LB::set_self(char *n, int os)
{
  name = n;
  mu_cState.set_self_2(name, ".cState", os + 0 );
  mu_firstTo.set_self_2(name, ".firstTo", os + 8 );
  mu_firstEntrySub.set_self_2(name, ".firstEntrySub", os + 10 );
  mu_memId.set_self_2(name, ".memId", os + 12 );
  mu_addrOffset.set_self_2(name, ".addrOffset", os + 13 );
}
...
class mu_1_LC
{
 public:
  ...
  void set_self(char *n, int os);
  mu_1_MemoryCacheStates mu_cState;
  mu_1_LC ( char *n, int os ) { set_self(n,os); };
  mu_1_LC ( void ) {};
...
virtual bool ismember() { Error.Error("Checking membership for a non-base type"); return TRUE;}
  ...
  void mu_1_LC::set_self_ar( char *n1, char *n2, int os ) {
    int l1 = strlen(n1), l2 = strlen(n2);
    strcpy( longname, n1 );
    longname[l1] = '[';
    strcpy( longname+l1+1, n2 );
  ...
  void mu_1_LC::set_self_2( char *n1, char *n2, int os ) {
    strcpy( longname, n1 );
    strcat( longname, n2 );
    set_self( longname, os );
  };
void mu_1_LC::set_self(char *n, int os)
{
  name = n;
  mu_cState.set_self_2(name, ".cState", os + 0 );
}
...
class mu_1_SubState
{
 public:
  ...
  mu_1_LB mu_lB;
  mu_1_LC mu_lC;
  mu_1_SubState ( char *n, int os ) { set_self(n,os); };
  mu_1_SubState ( void ) {};
...
virtual bool ismember() { Error.Error("Checking membership for a non-base type"); return TRUE;}
  ...
  void mu_1_SubState::set_self_ar( char *n1, char *n2, int os ) {
    int l1 = strlen(n1), l2 = strlen(n2);
    strcpy( longname, n1 );
    longname[l1] = '[';
    strcpy( longname+l1+1, n2 );
  ...
  void mu_1_SubState::set_self_2( char *n1, char *n2, int os ) {
    strcpy( longname, n1 );
    strcat( longname, n2 );
    set_self( longname, os );
  };
void mu_1_SubState::set_self(char *n, int os)
{
  name = n;
  mu_lB.set_self_2(name, ".lB", os + 0 );
  mu_lC.set_self_2(name, ".lC", os + 14 );
}
...
class mu_1_L0
{
 public:
  ...
  mu_1_MemoryCacheStates mu_mState;
  mu_0_boolean mu_co;
  mu_1_L0 ( char *n, int os ) { set_self(n,os); };
  mu_1_L0 ( void ) {};
...
virtual bool ismember() { Error.Error("Checking membership for a non-base type"); return TRUE;}
  ...
  void mu_1_L0::set_self_ar( char *n1, char *n2, int os ) {
    int l1 = strlen(n1), l2 = strlen(n2);
    strcpy( longname, n1 );
    longname[l1] = '[';
    strcpy( longname+l1+1, n2 );
  ...
  void mu_1_L0::set_self_2( char *n1, char *n2, int os ) {
    strcpy( longname, n1 );
    strcat( longname, n2 );
    set_self( longname, os );
  };
void mu_1_L0::set_self(char *n, int os)
{
  name = n;
  mu_secondEntry.set_self_2(name, ".secondEntry", os + 0 );
  mu_mState.set_self_2(name, ".mState", os + 2 );
  mu_co.set_self_2(name, ".co", os + 10 );
}
...
class mu_1_L1
{
 public:
  ...
  mu_1_MemoryCacheStates mu_cState;
  mu_1_L1 ( char *n, int os ) { set_self(n,os); };
  mu_1_L1 ( void ) {};
...
virtual bool ismember() { Error.Error("Checking membership for a non-base type"); return TRUE;}
  ...
  void mu_1_L1::set_self_ar( char *n1, char *n2, int os ) {
    int l1 = strlen(n1), l2 = strlen(n2);
    strcpy( longname, n1 );
    longname[l1] = '[';
    strcpy( longname+l1+1, n2 );
  ...
  void mu_1_L1::set_self_2( char *n1, char *n2, int os ) {
    strcpy( longname, n1 );
    strcat( longname, n2 );
    set_self( longname, os );
  };
void mu_1_L1::set_self(char *n, int os)
{
  name = n;
  mu_firstEntrySub.set_self_2(name, ".firstEntrySub", os + 0 );
  mu_firstLoop.set_self_2(name, ".firstLoop", os + 2 );
  mu_cState.set_self_2(name, ".cState", os + 4 );
}
...
class mu_1_L2
{
 public:
  ...
  mu_1_L2 ( char *n, int os ) { set_self(n,os); };
  mu_1_L2 ( void ) {};
...
virtual bool ismember() { Error.Error("Checking membership for a non-base type"); return TRUE;}
  ...
  void mu_1_L2::set_self_ar( char *n1, char *n2, int os ) {
    int l1 = strlen(n1), l2 = strlen(n2);
    strcpy( longname, n1 );
    longname[l1] = '[';
    strcpy( longname+l1+1, n2 );
  ...
  void mu_1_L2::set_self_2( char *n1, char *n2, int os ) {
    strcpy( longname, n1 );
    strcat( longname, n2 );
    set_self( longname, os );
  };
void mu_1_L2::set_self(char *n, int os)
{
  name = n;
  mu_firstEntrySub.set_self_2(name, ".firstEntrySub", os + 0 );
  mu_firstLoop.set_self_2(name, ".firstLoop", os + 2 );
  mu_cState.set_self_2(name, ".cState", os + 4 );
  mu_nextId.set_self_2(name, ".nextId", os + 12 );
}
...
class mu_1_ToState
{
 public:
  ...
  mu_1_L1 mu_l1;
  mu_1_L2 mu_l2;
  mu_1_ToState ( char *n, int os ) { set_self(n,os); };
  mu_1_ToState ( void ) {};
...
virtual bool ismember() { Error.Error("Checking membership for a non-base type"); return TRUE;}
  ...
  void mu_1_ToState::set_self_ar( char *n1, char *n2, int os ) {
    int l1 = strlen(n1), l2 = strlen(n2);
    strcpy( longname, n1 );
    longname[l1] = '[';
    strcpy( longname+l1+1, n2 );
  ...
  void mu_1_ToState::set_self_2( char *n1, char *n2, int os ) {
    strcpy( longname, n1 );
    strcat( longname, n2 );
    set_self( longname, os );
  };
void mu_1_ToState::set_self(char *n, int os)
{
  name = n;
  mu_l0.set_self_2(name, ".l0", os + 0 );
  mu_l1.set_self_2(name, ".l1", os + 12 );
  mu_l2.set_self_2(name, ".l2", os + 24 );
}
...
class mu_1_ExecState
{
 public:
  ...
  mu_1_ExecState ( char *n, int os ) { set_self(n,os); };
  mu_1_ExecState ( void ) {};
...
virtual bool ismember() { Error.Error("Checking membership for a non-base type"); return TRUE;}
  ...
  void mu_1_ExecState::set_self_ar( char *n1, char *n2, int os ) {
    int l1 = strlen(n1), l2 = strlen(n2);
    strcpy( longname, n1 );
    longname[l1] = '[';
    strcpy( longname+l1+1, n2 );
  ...
  void mu_1_ExecState::set_self_2( char *n1, char *n2, int os ) {
    strcpy( longname, n1 );
    strcat( longname, n2 );
    set_self( longname, os );
  };
void mu_1_ExecState::set_self(char *n, int os)
{
  name = n;
  mu_insType.set_self_2(name, ".insType", os + 0 );
  mu_insPhase.set_self_2(name, ".insPhase", os + 3 );
  mu_cTPtr.set_self_2(name, ".cTPtr", os + 6 );
  mu_tStat.set_self_2(name, ".tStat", os + 7 );
  mu_fetchOption.set_self_2(name, ".fetchOption", os + 12 );
  mu_data.set_self_2(name, ".data", os + 14 );
  mu_subState.set_self_2(name, ".subState", os + 15 );
  mu_toState.set_self_2(name, ".toState", os + 37 );
}
...
class mu_1_ExecUnit
{
 public:
  ...
  mu_1_ExecUnit ( char *n, int os ) { set_self(n,os); };
  mu_1_ExecUnit ( void ) {};
...
virtual bool ismember() { Error.Error("Checking membership for a non-base type"); return TRUE;}
  ...
  void mu_1_ExecUnit::set_self_ar( char *n1, char *n2, int os ) {
    int l1 = strlen(n1), l2 = strlen(n2);
    strcpy( longname, n1 );
    longname[l1] = '[';
    strcpy( longname+l1+1, n2 );
  ...
  void mu_1_ExecUnit::set_self_2( char *n1, char *n2, int os ) {
    strcpy( longname, n1 );
    strcat( longname, n2 );
    set_self( longname, os );
  };
void mu_1_ExecUnit::set_self(char *n, int os)
{
  name = n;
  mu_state.set_self_2(name, ".state", os + 0 );
  mu_reqPacket.set_self_2(name, ".reqPacket", os + 75 );
  mu_resPacket.set_self_2(name, ".resPacket", os + 101 );
}
...
class mu_1_Proc
{
 public:
  ...
  mu_1_Cache mu_cache;
  mu_1_Proc ( char *n, int os ) { set_self(n,os); };
  mu_1_Proc ( void ) {};
...
virtual bool ismember() { Error.Error("Checking membership for a non-base type"); return TRUE;}
  ...
  void mu_1_Proc::set_self_ar( char *n1, char *n2, int os ) {
    int l1 = strlen(n1), l2 = strlen(n2);
    strcpy( longname, n1 );
    longname[l1] = '[';
    strcpy( longname+l1+1, n2 );
  ...
  void mu_1_Proc::set_self_2( char *n1, char *n2, int os ) {
    strcpy( longname, n1 );
    strcat( longname, n2 );
    set_self( longname, os );
  };
void mu_1_Proc::set_self(char *n, int os)
{
  name = n;
  mu_exec.set_self_2(name, ".exec", os + 0 );
  mu_cache.set_self_2(name, ".cache", os + 122 );
}
...
void mu_1__type_2::set_self( char *n, int os)
  {
    int i=0;
    name = n;
array[i].set_self_ar(n,"ProcId_1", i * 141 + os);i++;
array[i].set_self_ar(n,"ProcId_2", i * 141 + os);i++;
array[i].set_self_ar(n,"ProcId_3", i * 141 + os);i++;
}
...
void mu_1__type_3::set_self( char *n, int os)
  {
    int i=0;
    name = n;
array[i].set_self_ar(n,"MemoryId_1", i * 12 + os);i++;
}
...
{"unmodified", &mu__condition_215, NULL, FALSE},
{"head element successor", &mu__condition_205, NULL, FALSE},
{"mid element neighbors", &mu__condition_193, NULL, FALSE},
{"sharing list head", &mu__condition_176, NULL, FALSE},
};
