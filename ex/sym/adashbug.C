/******************************
  Program "adashbug.m" compiled by "Eddy_Murphi Release 3.2.4"
...
#define PROTOCOL_NAME "adashbug"
#define BITS_IN_WORLD 1126
#define HASHC
#define PARALLEL
...
class mu_1_Proc: public mu__byte
{
 public:
  ...
  inline int value(int val)
  {
    ...
    if ((val >= 2) && (val <= 3)) return (mu__byte::value(val-1)+1);
  }
...
void mu_1_Request::set_self(char *n, int os)
{
  ...
  mu_Value.set_self_2(name, ".Value", os + 7 );
}
...
void mu_1_Reply::set_self(char *n, int os)
{
  ...
  mu_Addr.set_self_2(name, ".Addr", os + 5 );
  mu_InvCount.set_self_2(name, ".InvCount", os + 6 );
...
void mu_1__type_4::set_self(char *n, int os)
{
  ...
  mu_Entries.set_self_2(name, ".Entries", os + 4 );
}
...
void mu_1__type_9::set_self(char *n, int os)
{
  name = n;
  mu_State.set_self_2(name, ".State", os + 0 );
  mu_Value.set_self_2(name, ".Value", os + 4 );
  mu_InvCount.set_self_2(name, ".InvCount", os + 6 );
}
...
void mu_1__type_15::set_self( char *n, int os)
  {
    int i=0;
    name = n;
array[i].set_self_ar(n,"Home_1", i * 57 + os);i++;
array[i].set_self_ar(n,"Remote_1", i * 57 + os);i++;
array[i].set_self_ar(n,"Remote_2", i * 57 + os);i++;
}
...
void mu_1__type_16::set_self( char *n, int os)
  {
    int i=0;
    name = n;
array[i].set_self_ar(n,"Home_1", i * 171 + os);i++;
array[i].set_self_ar(n,"Remote_1", i * 171 + os);i++;
array[i].set_self_ar(n,"Remote_2", i * 171 + os);i++;
}
...
void mu_1__type_21::set_self( char *n, int os)
  {
    int i=0;
    name = n;
array[i].set_self_ar(n,"Home_1", i * 189 + os);i++;
array[i].set_self_ar(n,"Remote_1", i * 189 + os);i++;
array[i].set_self_ar(n,"Remote_2", i * 189 + os);i++;
}
...
void mu_1__type_23::set_self( char *n, int os)
  {
    int i=0;
    name = n;
array[i].set_self_ar(n,"Home_1", i * 10 + os);i++;
}
...
/*** Variable declaration ***/
mu_1__type_21 mu_ReplyNet("ReplyNet",513);

/*** Variable declaration ***/
mu_1__type_22 mu_Procs("Procs",1080);

/*** Variable declaration ***/
mu_1__type_23 mu_Homes("Homes",1116);
